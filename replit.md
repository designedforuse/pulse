...
- **Live Scores:** Real-time score updates for in-progress games, polled every 30 seconds and displayed inline on event cards and in detail sheets. Score display varies for different sports (e.g., rugby period data, cricket batting summaries).
